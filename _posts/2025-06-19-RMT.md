...
(Marčenko and Pastur 1967): when $\mathbf{C} = \mathbf{I}_p$ and
$n, p \to \infty$ with $p/n \to c \in (0, \infty)$, the empirical
...
This modeling limitation was significantly relaxed by El Karoui (2009)
and Pajor and Pastur (2009), who showed that the proof of
Theorem [3](#thm:silverstein-bai){reference-type="ref"
...
*concentrated random vector* (El Karoui 2009), thereby significantly
...
::: {#ref-couillet2022random .csl-entry}
Couillet, Romain, and Zhenyu Liao. 2022. *Random Matrix Methods for
Machine Learning*. Cambridge University Press.
:::

::: {#ref-elkaroui2009 .csl-entry}
El Karoui, Noureddine. 2009. "Concentration of Measure and Spectra of
Random Matrices: Applications to Correlation Matrices, Elliptical
Distributions and Beyond." *The Annals of Applied Probability* 19 (6):
2362--2405.
:::

::: {#ref-Marcenko1967 .csl-entry}
Marčenko, V. A., and Leonid Pastur. 1967. "Distribution of Eigenvalues
for Some Sets of Random Matrices." *Math USSR Sb* 1 (January): 457--83.
:::

::: {#ref-pajor2009 .csl-entry}
Pajor, Alain, and Leonid Pastur. 2009. "Spectral Analysis of Large
Dimensional Random Matrices and Related Topics." *arXiv Preprint
arXiv:0904.3961*.
:::
:::::::
